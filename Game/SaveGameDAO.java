...
public class SaveGameDAO {
    ...
    public SaveGameDAO(Board board, GameFlowManager gfm, ArrayList<JLabel> labels){
        this.board = board;
        this.gfm = gfm;
    ...
    public void createSave(){
        try(PrintWriter out = new PrintWriter(new FileWriter(nameBlack + "_" + nameWhite + ".txt"))) {
            out.write(save);
        } catch (IOException e1) {
            System.err.println("Error occurred");
            e1.printStackTrace();
        }
        try(PrintWriter out = new PrintWriter(new FileWriter(nameBlack + "_" + nameWhite + ".doc"))) {
            out.write(save);
        } catch (IOException e1) {
            System.err.println("Error occurred");
            e1.printStackTrace();
